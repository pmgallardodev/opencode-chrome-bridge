...
// Tool metadata lives in ./tool-metadata.js: OpenCode's plugin loader treats
// every module export as a plugin entrypoint, so the entrypoint must not
// re-export non-function values.
import {
